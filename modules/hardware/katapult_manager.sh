...
function flash_katapult_dfu() {
    ...
    # Try generic flash, likely needs specific ID but make flash often handles it if config is right
    make flash
    
    log_info "If 'make flash' failed, you might need to specify the device ID."
    read -p "  Press Enter..."
}
